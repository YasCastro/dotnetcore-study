...
namespace MyCoffeeShop.Controllers
{
    public class CoffeeController : Controller
    {
        ...
        public CoffeeController(MvcCoffeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ExpirationDate,Grounds,Roast")] Coffee coffee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ExpirationDate,Grounds,Roast")] Coffee coffee)
        {
            if (id != coffee.Id)
            {
                return NotFound();
